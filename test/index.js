...
describe('API ENDPOINT TESTING', () => {
  ...
  it('POST BOOKING PAGE', (done) => {
    ...
    const dataSample = {
      ...
      duration: 2,
      bookingStartDate: '10-02-2021',
      bookingEndDate: '11-02-2021',
      firstName: 'Ita',
      lastName: 'Djuita',
      email: 'itaDjuita@gmail.com',
      phoneNumber: '082116765513',
      accountHolder: 'Ita',
      bankFrom: 'Mandiri',
    };
    chai
      ...
      .attach('image', fs.readFileSync(dataSample.image), 'test-image.jpg')
      .end((err, res) => {
        expect(err).to.be.null;
